...
<cfoutput>#firstname#,#lastname#,<cfif Len(email)>#decrypt(email, application.contactInfoEncryptKey, 'AES')#</cfif>,#address1#,#address2#,#city#,#state#,#zip#,<cfif Len(phone)>#decrypt(phone, application.contactInfoEncryptKey, 'AES')#<cfelse></cfif>,#Dateformat(createdat, "dd mmm yyyy")#,#camefrom##crlf#</cfoutput>
</cfloop>
</cfsavecontent>
