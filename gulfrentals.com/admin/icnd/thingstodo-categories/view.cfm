<cfset page.title ="Meta Viewer for Things to Do - Categories">
...
<cfif isdefined('url.success')>
  ...
  <cfloop index="i" from="#variables.submitStart#" to="#variables.submitEnd#">
    <cfquery datasource="#application.dsn#">
      ...
      meta_title = <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form['meta_title_#i#']#">,
      meta_description = <cfqueryparam CFSQLType="CF_SQL_LONGVARCHAR" value="#form['meta_description_#i#']#">
      ...
      <div class="widget-content nopadding">
        ...
        <cfoutput query="getinfo">
          <tr>
            ...
            <td><a href="/thingstodo/#slug#" target="_blank">#title#</a></td>            
            <td><textarea cols="15" rows="8" name="meta_title_#getinfo.CurrentRow#" class="mceNoEditor">#meta_title#</textarea></td>
            <td><textarea cols="15" rows="8" name="meta_description_#getinfo.CurrentRow#" class="mceNoEditor">#meta_description#</textarea></td>
