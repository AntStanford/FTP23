  ...
  <div class="widget-content nopadding">
    ...
    <cfoutput query="getinfo">  				    	
      <tr>
        ...
        <td>#Address#</td>
        <td>#status#</td>
        <td width="58"><a href="/long-term-rental/#slug#" target="_blank" class="btn btn-mini btn-info"><i class="icon-search icon-white"></i> View</a></td>
        <td width="68"><a href="gallery/formmulti.cfm?id=#id#" class="btn btn-mini btn-warning"><i class="icon-search icon-white"></i> Photos</a></td>
