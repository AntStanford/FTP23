            ...
            $element.find('img').not('#divCb img').each(function () {
                ...
                if (jQuery(this).attr('src').indexOf('base64') != -1) {
                    ...
                    if (jQuery('#form-' + count).length == 0) {
                        ...
                        '<input id="hidimg_' + count + '" name="hidimg_' + count + '" type="hidden" />' +
                        '<input id="hidname_' + count + '" name="hidname_' + count + '" type="hidden" />' +
                        '<input id="hidtype_' + count + '" name="hidtype_' + count + '" type="hidden" />' +
                    ...
                    jQuery('#hidimg_' + count).val(image);
