...
<cfelseif isdefined('form.id')> <!--- update statement --->
  ...
  <cfquery datasource="#application.dsn#">
    ...
    <cfif isdefined('form.isCustomSearchPage') and form.isCustomSearchPage eq 'yes' and not mySlug contains 'search'>
      slug = <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="search/#mySlug#">,
    <cfelse>
...
<cfelse>  <!---insert statement--->
  ...
  <cfquery dataSource="#application.dsn#" result="theinsert">
    ...
    values(
      ...
      <cfif isdefined('form.isCustomSearchPage') and not mySlug contains 'search'>
       <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="search/#mySlug#">,
      <cfelse>
