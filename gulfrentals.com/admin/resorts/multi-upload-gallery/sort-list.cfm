...
<cfquery name="getphotos" dataSource="#dsn#">
   select id,thefile from cms_assets where foreignKey = <cfqueryparam CFSQLType="CF_SQL_varchar" value="#url.id#"> and section = 'resorts' order by sort
</cfquery>
		...
		<ul id="sort-list" class="thumbnails">
  		  <cfloop query="getphotos">
    			<li class="span2" id="#id#" style="border:none">
    			 <a href="javascript:;" role="button" class="thumbnail" data-toggle="modal"><img src="/images/resorts/#thefile#"></a> 
    		  </li>
    		</cfloop>
  		</ul>
