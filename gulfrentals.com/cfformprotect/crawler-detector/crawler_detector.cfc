<cfcomponent displayname = "Crawler Detector">
  ...
  <cffunction name = "isCrawler" access="public" output="false" hint="check if UserAgent is crawler">
    <cfargument name="userAgent" type="String" required="Yes" hint="CGI.HTTP_USER_AGENT">

    <cfset testUserAgent = userAgent>
    <cfset testUserAgent = REReplaceNoCase(testUserAgent, ArrayToList(this.exclusions,'|'), '', 'All')>

    <cfset testUserAgent = REMatchNoCase(ArrayToList(this.crawlers,'|'), testUserAgent)>

    <cfreturn NOT ArrayIsEmpty(testUserAgent)/>

  </cffunction>



  <cffunction name = "setExclusions" access="public">

    <cfset this.exclusions =[
      'Safari.[\d\.]*',
      'Firefox.[\d\.]*',
      'Chrome.[\d\.]*',
      'Chromium.[\d\.]*',
  ...
  <cffunction name = "setCrawlers" access="public">
    <cfset this.crawlers = [
      '.*Java.*outbrain',
      '008\/',
      '192\.comAgent',
