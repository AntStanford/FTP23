...
<div class="adv-search-container container">
  ...
  <div id="advSearchWrap" name="inquire" class="adv-search-wrap">
    <div class="adv-search-heading header site-color-1-bg text-white"><i class="fa fa-search" aria-hidden="true"></i> Enhance your Search</div>
    <div class="adv-search-body">

      <form action="/<cfoutput>#application.settings.mls.dir#</cfoutput>/results" role="form" class="mls-search-form" method="POST"><!--- removed .cfm --->
        ...
        <fieldset class="row">
          <div class="form-group col-xs-12">
            <div class="adv-search-heading">Search Details</div>
          </div>
          <div class="form-group col-xs-6 col-sm-6 col-md-4">
            <label>
        ...
        <fieldset class="row">
            <div class="form-group col-xs-12">
            <div class="adv-search-heading">Basic Criteria</div>
          </div>
          <div class="form-group col-xs-6 col-sm-6 col-md-4">
        ...
        <fieldset class="row">
          <div class="form-group col-xs-12">
            <div class="adv-search-heading">Select An Area</div>
          </div>
        ...
        <cfif settings.mls.AsShowAdvancedSearchPanel is "1">
          <fieldset class="row">
            <div class="form-group col-xs-12">
              <div class="adv-search-heading">Advanced Search Criteria</div>
            </div>
