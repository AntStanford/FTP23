...
<body<cfif cgi.script_name eq '/#application.settings.mls.dir#/results.cfm' OR (isdefined('page.partial') and page.partial eq 'results.cfm') OR (isdefined('page.isCustomSearchPage') and page.isCustomSearchPage eq 'yes') OR (parameterexists(id) and (getinfo.layout contains 'full-mls.cfm')) or (isdefined('savedsearch') and savedsearch)> class="results-body"</cfif>>
  <div class="wrapper">
    <div class="mls-header-wrap<cfif cgi.script_name eq '/#application.settings.mls.dir#/results.cfm' OR (isdefined('page.partial') and page.partial eq 'results.cfm') OR (isdefined('page.isCustomSearchPage') and page.isCustomSearchPage eq 'yes')> results-header-wrap</cfif>">
      <div class="header">
        <div class="header-logo">
          <a href="/"><img src="/mls/images/logo-gulfrentals.png" alt="The Shore Group - Chincoteague Real Estate"></a>
        </div>
        ...
        <div class="header-actions">
          ...
          <!-- RECENTLY VIEWED -->
          <a href="javascript:;" class="header-actions-action" id="recentlyViewedToggle">
          ...
          <!-- FAVORITES -->
          <a href="javascript:;" class="header-actions-action" id="favoritesToggle">
         ...
         <!--- <span id="mlsAccountLink">
            <cfif isdefined('cookie.loggedin') and len(cookie.loggedin)> <!-- IF LOGGED IN, DISPLAY NAME -->
              <a href="/mls/my-profile.cfm" class="header-actions-action header-action-create-account">
                <div rel="tooltip" data-placement="bottom" title="View My Account">
                  <small><cfoutput>#cookie.userfirstname#</cfoutput></small>
            <cfelse>
              <a class="header-actions-action header-action-create-account" data-toggle="modal" data-target="#loginModal">
