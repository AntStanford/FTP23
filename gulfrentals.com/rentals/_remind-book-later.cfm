...
<cfelse>
  <a href="javascript:;" class="btn btn-block site-color-5-bg text-white" data-toggle="modal" data-target="#remindBookLater">Remind me to book this later</a><br>
</cfif>
<cf_htmlfoot>
      ...
      <form id="reminderForm" action="_submit.cfm" method="post">
        ...
        <div class="modal-body">
          ...
          <cfoutput>
            ...
            <input type="hidden" name="ReminderURL" value="<cfif https is 'off'>http<cfelse>https</cfif>://#http_host##script_name#&reminderset=success">
