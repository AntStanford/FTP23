...
<div id="travelDates" class="property-dates">
  ...
  <div id="APIresponse" class="property-cost">
    <cfif isdefined('APIresponse')><cfoutput>#APIresponse#</cfoutput><cfelse><input type="hidden" id="enteredpromocode" name="enteredpromocode" /></cfif>
  ...
  <button id="mobileClose" class="btn site-color-3-lighten-bg site-color-3-bg-hover">
