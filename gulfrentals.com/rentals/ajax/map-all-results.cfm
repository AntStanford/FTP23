...
<cfif isdefined('tmpMapData') and isquery(tmpMapData)>
	...
	<cfloop query="tmpMapData">
		...
		<cfset returnJson &= '["#tmpMapData.seopropertyname#","#tmpMapData.unitcode#","#tmpMapData.mapphoto#","#tmpMapData.unitshortname#","#tmpMapData.bedrooms#","#tmpMapData.bathrooms#","#tmpMapData.maxoccupancy#","#tmpMapData.latitude#","#tmpMapData.longitude#","#tmpMapData.MapPrice#",0,""]' />
