...
<cfelse>
  ...
  <div class="property-wrap">
    ...
    <div id="propertyDetails" class="property-details-wrap" data-unitcode="#property.propertyid#" data-id="#property.propertyid#">
      ...
      <div class="property-tabs-wrap">
        ...
        <ul id="propertyTabs" class="property-tabs tabs tab-group">
          ...
          <!---<li><a href="#cleaning"><i class="fa fa-align-left" aria-hidden="true"></i> <span>Cleaning</span></a></li>--->
        </ul><!-- END propertyTabs -->
      </div>
      ...
      <!---<cfinclude template="_cleaning-tab.cfm">--->
    ...
    <div class="mobile-dates-toggle-wrap">
      <button id="mobileDatesToggle" class="btn site-color-1-bg site-color-1-bg-hover text-white" type="button"><i class="fa fa-chevron-right" aria-hidden="true"></i> Get My Quote</button>
      <small>Find Available Dates For this Property</small>
    </div>
  </div><!-- END property-wrap -->

  <button id="returnToTop" class="btn site-color-4-bg site-color-4-bg-hover text-white" type="button">
