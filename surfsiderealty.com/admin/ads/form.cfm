<cfif isdefined('url.id')>
  ...
  <cfquery name="getinfo" dataSource="#settings.dsn#">
    select * from cms_ads where id = <cfqueryparam CFSQLType="CF_SQL_INTEGER" value="#url.id#">
  </cfquery>
...
<cfif isdefined('url.success') and isdefined('url.id')>
  <div class="alert alert-success">
    ...
    <strong>Update successful!</strong> Continue editing this ad or <a hreflang="en" href="index.cfm">go back.</a>
  </div>
<cfelseif isdefined('url.success')>
  <div class="alert alert-success">
    <button class="close" data-dismiss="alert">×</button>
    <strong>Success!</strong> Add another ad or <a hreflang="en" href="index.cfm">go back.</a>
  </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          ...
          <li class="span2">
            ...
            <br /><br /><a hreflang="en" href="submit.cfm?id=#id#&deletephoto" class="btn btn-danger" data-confirm="Are you sure you want to delete this photo?"><i class="icon-remove icon-white"></i> Delete</a> 
          </li>
