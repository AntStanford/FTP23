...
<cfquery name="GetImpressions" dataSource="#settings.dsn#">
select * from cms_ads_impressions
...
<cfquery name="GetClicks" dataSource="#settings.dsn#">
select * from cms_ads_clicks
where createdat between <cfqueryparam value="#StartDate#" cfsqltype="CF_SQL_TimeStamp"> and  <cfqueryparam CFSQLType="CF_SQL_TimeStamp" value="#EndDate# 23:59:59">
</cfquery>
...
<td><input type="submit" class="btn btn-success" name="RunReport" value="Run Report"></td><td><a hreflang="en" href="index.cfm" class="btn btn-warning">Reset</a></td>
</tr>
</table>
</cfoutput>
</form>
...
<p>
<a hreflang="en" href="form.cfm" class="btn btn-success"><i class="icon-plus icon-white"></i>Add New</a>
</p>
...
<td width="65"><a hreflang="en" href="submit.cfm?id=#id#&delete" class="btn btn-mini btn-danger" data-confirm="Are you sure you want to delete this ad?"><i class="icon-remove icon-white"></i> Delete</a></td> 
</tr>
</cfoutput>
