...
<cfoutput>
  ...
  <cfif isdefined('url.success') and isdefined('url.id')>
    <div class="alert alert-success">
      ...
      <strong>Update successful!</strong> Continue editing this #module# or <a hreflang="en" href="index.cfm">go back.</a>
    </div>
  <cfelseif isdefined('url.success')>
    <div class="alert alert-success">
      <button class="close" data-dismiss="alert">x</button>
      <strong>Success!</strong> Add another #module# or <a hreflang="en" href="index.cfm">go back.</a>
    </div>
  </cfif>
      ...
      <form action="submit.cfm" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="control-group">
			    ...
			    <div class="controls">
			      ...
			      <div class="help-block">(Image must be resized to 264 x 177 before upload)</div>
