<cfinclude template="lead-sources_.cfm">
		...
		<section>
			<div class="panel">
				<div class="panel-heading">
					...
					<ul>
						<li class="headlinks"><h2>Lead Sources</h2></li>
						<cfif isdefined('url.id') and LEN(url.id)><li class="headlinks"><a hreflang="en" href="lead-sources.cfm">View All</a></li></cfif>
					</ul>           
				...
				<div class="panel-body">
					<table class="table table-hover table-striped">
						...
						<tr><td colspan="4">
							...
							<form method="post" action="lead-sources.cfm">
								...
								<table id="dripSearch">
									...
									<tr>
										<td><cfoutput><input type="text" name="sourcename" <cfif isdefined('url.id') and LEN(url.id)>value="#getInfo.source#"</cfif>></cfoutput></td>
						...
						<tbody>
							...
							<tr>
								<td>#currentrow#.</td>
								<td>#source#</td>
								<td><a hreflang="en" href="lead-sources.cfm?id=#id#" class="edit">Edit</a></td>
								<td><a hreflang="en" href="lead-sources.cfm?id=#id#&delete=yes" class="delete" onclick="return confirm('Are you sure you wish to delete this Source?')">Delete</a></td>
							</tr>
							</cfoutput>
						</tbody>
					</table>
