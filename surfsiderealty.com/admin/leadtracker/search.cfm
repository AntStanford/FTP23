				...
				<div class="panel-body">
					<table class="table table-hover table-striped">
						...
						<tbody>
							...
							<tr>
								<td>#currentrow#.</td>
								<td><a hreflang="en" href="/admin/leadtracker/contact-details.cfm?id=#id#&display=history" class="edit">#capFirstTitle(firstname)# #capFirstTitle(lastname)#</a></td>
								...
								<td><a hreflang="en" href="/admin/leadtracker/contact-details.cfm?id=#id#&display=history" class="edit">View</a></td>
