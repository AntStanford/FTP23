<cfset page.title ="Long Term Rental Photos">
<cfset module = 'photo'>

<cfquery name="getphotos" dataSource="#settings.dsn#">
   select id,thefile 
   from cms_assets where foreignKey = <cfqueryparam CFSQLType="CF_SQL_varchar" value="#url.id#"> 
...
<cfif url.id neq '' and getphotos.recordcount gt 0>
		...
		<ul id="sort-list" class="thumbnails">
  		  <cfloop query="getphotos">
    			<li class="span2" id="#id#" style="border:none">
    			 <a href="javascript:;" role="button" class="thumbnail" data-toggle="modal"><img src="/images/longtermrentals/#thefile#"></a> 
    		  </li>
    		</cfloop>
  		</ul>
