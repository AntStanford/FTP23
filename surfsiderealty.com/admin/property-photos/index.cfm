...
<cfquery name="getEscapiaProperties" datasource="#settings.dsn#">
  select strpropid,strname from pp_propertyinfo order by STRpropid
</cfquery>
  ...
  <div class="well">
    <form class="form-inline" action="index.cfm">
      <div class="form-group">
        Property
        <select name="strpropid" style="width:350px">
          <option value="0"> - Select A Property - </option>
          <cfloop query="getEscapiaProperties">
            <option value="#strpropid#" <cfif strpropid is url.strpropid> SELECTED </cfif>>#strpropid# - #strname#</option>
          </cfloop>
        </select>
          ...
          <div class="widget-content">
            ...
            <ul id="sort-list" class="thumbnails">
              <cfloop query="getimages">
                <li id="li#id#" style="border:none">
                  <a href="##modal#id#" role="button" class="thumbnail" data-toggle="modal">
                    <img src="#uppicture#/#image#" title="#tag#" style="height:135px;object-fit:cover;">
                  </a>
                  <div class="img-desc">
                    <p><b>File:</b> #image#</p>
                    <p><b>Tag:</b> <cfif len(tag)>#tag#<cfelse>None</cfif></p>
                  </div>
                  <a href="delete.cfm?image=#image#&imageid=#getimages.id#&strpropid=#url.strpropid#" class="btn btn-danger">
