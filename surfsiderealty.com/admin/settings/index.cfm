    ...
    <div class="widget-content nopadding">
      <form action="submit.cfm" method="post" class="form-horizontal">
            ...
            <div class="well">
              <cfif FileExists('#adminPath#\testimonials\index.cfm')>
	              <div class="control-group">
	                <label class="control-label" style="padding:10px 0 3px;cursor:pointer;">
	                  <input type="radio" name="leftCol" value="lc_testimony" checked style="position:relative;top:-4px;margin-right:5px;">
	                  Random Testimony
	                </label>
	              </div>
              </cfif>
              ...
              <cfif FileExists('#rootPath#\blog\index.php')>
	              <div class="control-group">
	                <label class="control-label" style="padding:10px 0 3px 26px;cursor:pointer;">
          ...
          <div class="span6">
            ...
            <div class="well">
              <cfif FileExists('#adminPath#\testimonials\index.cfm')>
	              <div class="control-group">
	                <label class="control-label" style="padding:10px 0 3px;cursor:pointer;">
	                  <input type="radio" name="rightCol" value="rc_testimony" checked style="position:relative;top:-4px;margin-right:5px;">
	                  Random Testimony
	                </label>
	              </div>
              </cfif>
        ...
        <div class="control-group">
          ...
          <div class="controls">
          	<input type="text" name="googleAnalytics" value="#getSettings.googleAnalytics#">
          	<div class="help-block">
          		(Only insert the client identifier, not the entire Javascript code. ex. UA-12345-1)
          	</div>
          </div>
        </div>
        <div class="widget-title">
