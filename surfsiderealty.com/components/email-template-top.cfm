...
<body>
  <!-- Start of header -->
  <table width="100%" bgcolor="#06407c" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header" style="padding-top:8px;">
    <tbody>
      <tr>
        <td>
              ...
              <tr>
                <td width="100%" style="padding:0 5px 0 5px">
                  <a target="_blank" href="http://<cfoutput>#settings.website#</cfoutput>">
                    <img src="http://<cfoutput>#settings.website#</cfoutput>/images/layout/logo.png"  alt="" border="0" style="display:block;border:none;outline:none;text-decoration:none;margin:0 auto;padding:12px 0;max-width:100%;">
                  </a>
                </td>
              </tr>
            </tbody>
                      ...
                      <tr>
                        <td>
                          <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                            <tbody>
                              <tr>
                                <td style="font-family:Helvetica,arial,sans-serif;font-size:14px;color:#555;line-height:22px;">