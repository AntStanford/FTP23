<cftry>
  ...
  <cfcatch type="Any">
    <cfmail to="support@icoastalnet.com" from="no-reply@icoastal.net" subject="Error on #application.dsn# Listrak API">
      Look for the listrak.cfm file found in the /components folder to start debugging.
      <cfdump var="#cgi#">
      ***********************************
      <cfdump var="#httpResponse.fileContent#">
    </cfmail>
