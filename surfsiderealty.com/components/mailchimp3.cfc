<cfcomponent displayname="MailChimp" hint="I use the Mail Chimp API">
	<cfscript>
		...
		this.options.output = "";
		this.options.apikey = "";
		this.options.mc_server = "";
	</cfscript>

	<cffunction name="init" access="public" returntype="Any">
		<cfargument name="apikey" required="true">
		<cfargument name="audience_id" required="true">
		<cfargument name="output" required="false" default="json" type="string">

		<cfscript>
			this.options.apikey = arguments.apikey;
			this.options.audience_id = arguments.audience_id;
			this.options.output = arguments.output;
			this.options.mc_server = right( this.options.apikey, 4 );
			this.options.serviceURL = 'https://' & this.options.mc_server & '.api.mailchimp.com/3.0';
		</cfscript>
	...
	<cffunction name="listSubscribe">
		...
		<cfargument name="lists" required="false" type="struct">
		<cfargument name="output" required="false" type="string" default="#this.options.output#">
		...
		<cfset variables.contact_json['email_address'] = arguments.email />
		<cfset variables.contact_json['status'] = 'subscribed' />

		<cfhttp url="#this.options.serviceURL#/lists/#this.options.audience_id#/members" method="POST">
			<cfhttpparam type="header" name="content-type" value="application/json" />
			<cfhttpparam type="header" name="Authorization" value="apikey #this.options.apikey#" />
	...
	<cffunction name="listSubscribe" access="public" returntype="any" hint="I subscribe the provided e-mail to a list">
		...
		<cfhttp url="#this.options.serviceURL#" method="post">
			...
			<cfif isDefined("arguments.lists")>
				<cfset count = 0 />
