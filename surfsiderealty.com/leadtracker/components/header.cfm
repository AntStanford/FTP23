...
<!---<cfif NOT isDefined('session.loggedInUserStruct')>
	<cflocation addToken="no" url="/admin/login.cfm?logout">
</cfif>--->

<cfif (isdefined('session.loggedInUserStruct.LoggedInAdminID') is "No" and isdefined('session.loggedInUserStruct.LoggedInAgentID') is "No")>

  <cfif isdefined('url.emailreplay') and isdefined('url.id')>
    <!---<cflocation url="/admin/login.cfm?msgreply=#url.id#" addtoken="No">--->
    <cflocation url="/leadtracker/login.cfm?msgreply=#url.id#" addtoken="No">
  <cfelse>
    <!---<cflocation url="/admin/login.cfm" addtoken="No">--->
    <cflocation url="/leadtracker/login.cfm" addtoken="No">
  </cfif>
