...
<cfelseif isdefined('url.display') and url.display eq "notes">
	...
	<cfif isdefined('url.deletenote')>
		<cfquery name="delnote" datasource="#mls.dsn#">
			...
			where clientid = <cfqueryparam CFSQLType="CF_SQL_INTEGER" value="#url.id#"> and id = <cfqueryparam CFSQLType="cf_sql_varchar" value="#url.deletenote#"> and privatepublic = 'Private'
		</cfquery>
...
<cfelseif isdefined('url.display') and url.display eq "Documents">
	...
	<cfif isdefined('url.DeleteDocument')>
		...
		<CFQUERY DATASOURCE="#mls.dsn#" NAME="delete">
			...
			WHERE clientid = <cfqueryparam CFSQLType="CF_SQL_INTEGER" value="#url.id#"> and id = <cfqueryparam CFSQLType="cf_sql_varchar" value="#url.DeleteDocument#">
			order by createdat desc
		</CFQUERY> 
