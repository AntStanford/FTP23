					...
					<div class="panel-body">
						<header>
								...
								<cfif isdefined('url.id') and LEN(url.id)>
									...
									<div><a hreflang="en" href="/leadtracker/contacts/create-outlook-contact.cfm?id=#id#" target="_blank"><img src="/leadtracker/images/vcard.gif" alt="Create Outlook Contact" border="0"></a></div>
								</cfif>
						</header>
						<div class="forms">
							<ul>
							...
							<ul class="doubled">
								...
								<li class="full notes">
									<ul>
										...
										<cfif isdefined('url.id') and LEN(url.id)>
											<li class="copy">
												<a hreflang="en" href="/leadtracker/contacts/lightboxes/saved-search.cfm?id=#url.id#" class="fb_savedsearch">Create Saved Search</a>
											</li>
											<li class="delete">
