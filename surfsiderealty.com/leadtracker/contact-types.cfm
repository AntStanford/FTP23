<cfinclude template="contact-types_.cfm">
		...
		<section>
			<div class="panel">
				<div class="panel-heading">
					...
					<ul>
						<li class="headlinks"><h2>Types of Contact</h2></li>
						<cfif isdefined('url.id') and LEN(url.id)><li class="headlinks"><a hreflang="en" href="contact-types.cfm">View All</a></li></cfif>
					</ul>           
				...
				<div class="panel-body">
					<table class="table table-hover table-striped">
						...
						<tr><td colspan="4">
							...
							<form method="post" action="contact-types.cfm">
								...
								<table id="dripSearch">
									...
									<tr>
										<td><cfoutput><input type="text" name="typename" <cfif isdefined('url.id') and LEN(url.id)>value="#getInfo.contacttype#"</cfif>></cfoutput></td>
						...
						<tbody>
							...
							<tr>
								<td>#currentrow#.</td>
								<td>#contacttype#</td>
								<td><a hreflang="en" href="contact-types.cfm?id=#id#" class="edit">Edit</a></td>
								<td><a hreflang="en" href="contact-types.cfm?id=#id#&delete=yes" class="delete" onclick="return confirm('Are you sure you wish to delete this Type?')">Delete</a></td>
							</tr>
							</cfoutput>
						</tbody>
					</table>
