  ...
  <cfif isdefined('cookie.LoggedInAgentID') and cookie.LoggedInAgentID neq "50">and cl_accounts.agentid = <cfqueryparam cfsqltype="cf_sql_numeric" value="#cookie.LoggedInAgentID#"></cfif>
  ...
  <cfif showing eq 1><cfset displayaction = "Showing"><cfelse><cfset displayaction = "Notes"></cfif>
  	<li class="reminder"><a hreflang="en" href="#cgi.script_name#?#cgi.query_string#&ArchiveReminderID=#GetReminders.id#" onclick="return confirm('Are you sure you wish to archive this?')"><img src="/leadtracker/images/redx.png" border="0">
