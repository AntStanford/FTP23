...
<cfif settings.hasCartAbandonment eq 'Yes'>
   ...
   <cfelse>
      ...
      <cfmail subject="error from #cgi.http_host#" to="jrichey@icoastalnet.com" from="#cfmail.company# <#cfmail.username#>" server="#cfmail.server#" username="#cfmail.username#" password="#cfmail.password#" port="#cfmail.port#" useSSL="#cfmail.useSSL#" type="HTML" bcc="" cc="">
