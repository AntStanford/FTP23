...
<cfelse>
	...
	<cfquery name="specialsUnitCheck" dataSource="#settings.dsn#">
		select
			specialID
		from
			cms_specials_properties
		where
			unitcode = <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#property.propertyid#">
			AND active = <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="Yes">
	</cfquery>

	<cfif specialsUnitCheck.recordcount gt 0>

		<cfloop query = "specialsUnitCheck">
			...
			<cfquery name="confirmValidSpecial" dataSource="#settings.dsn#">
				...
				from
					cms_specials
				where
					id = <cfqueryparam CFSQLType="CF_SQL_INTEGER" value="#specialsUnitCheck.specialID#">
