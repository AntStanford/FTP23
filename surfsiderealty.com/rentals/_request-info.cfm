  ...
  <div class="info-wrap-body">
    ...
    <form role="form" id="propertyContactForm" class="contact-form validate" method="post">
      ...
      <fieldset class="row">
        ...
        <div class="form-group col-xs-12">
          <button type="submit" name="" class="btn site-color-1-bg site-color-1-lighten-bg-hover text-white" onClick="ga('send','event','Contact Form','Submit','Location - Property Contact Form','1');">
