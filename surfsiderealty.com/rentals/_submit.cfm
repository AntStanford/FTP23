...
<!---START: price alerts--->
   <cfif isdefined('form.SetPriceAlert')>

   		<cfquery dataSource="#settings.dsn#">
         insert into cms_price_alerts_signups (email,firstname,lastname,unitcode,startdate,enddate)
         values(
			...
			<cfqueryparam CFSQLType="CF_SQL_DATE" value="#form.PriceAlertStart#">,
			<cfqueryparam CFSQLType="CF_SQL_DATE" value="#form.PriceAlertEnd#">
            )
      </cfquery>

	  	<cflocation url="#ReminderURL#" addtoken="No">

   </cfif>
   <!---END: price alerts--->


   <!---START: cancellation notifications--->
   <cfif isdefined('form.SendCancelationNotifications')>

   		<cfquery dataSource="#settings.dsn#">
         insert into cms_notify_cancellations (email,firstname,unitcode,startdate,enddate,FlexibleOrStrict)
         values(
		 	<cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form.CancelationNotificationEmail#">,
			<cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form.CancelationNotificationFirstName#">,
            <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form.unitcode#">,
			<cfqueryparam CFSQLType="CF_SQL_DATE" value="#form.CancelationNotificationStartDatet#">,
			<cfqueryparam CFSQLType="CF_SQL_DATE" value="#form.CancelationNotificationEndDate#">,
			<cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form.CancelationNotificationFlexibleDates#">
            )
      </cfquery>
   ...
   <!---END: cancellation notifications--->
