  <div class="booking-footer-wrap
    ...
    <cfoutput>
      <ul class="booking-footer-quick-links">
        ...
        <li><a href="/contact-surfside-realty"><i class="fa fa-envelope"></i><span>Get In Touch</span></a></li>
      </ul>
...
<script src="/<cfoutput>#settings.booking.dir#</cfoutput>/javascripts/global.min.js?v=3" defer></script>
