...
<!--- <a hreflang="en" href="#inquire" class="button contact-button">Inquire About Property</a> --->
<!--- <a name="inquire"></a> --->
<form id="contact-form">
  ...
  <textarea></textarea>
  <span>
    <input type="submit" value="Submit" class="button" onClick="ga('send', 'event', { eventCategory: 'lead', eventAction: 'submitted', eventLabel: 'real-estate-contact-form'});">
