...
<!---   <h2>Create An Account</h2> --->
  ...
  <cfif isdefined('processform')>
    ...
    <cfif isValid('email',form.email) and LEN(form.thepassword) and LEN(form.firstname) and LEN(form.lastname)>
    <!--- good to go --->
    <cfelse>



<cfinclude template="/sales/lightboxes/create-account-table.cfm">
    <cfabort>
    ...
    <cfif check.recordcount gt 0>
      <h3> Our system shows that you already have an acccount with <cfoutput>#mls.companyname#</cfoutput>. <br><br> Please try logging in again.</h3>
      <cfinclude template="/sales/lightboxes/create-account-table.cfm">
<!---       <cfinclude template="/sales/lightboxes/_footer.cfm"> --->
    ...
    <cfif Cffp.testSubmission(form)>
      ...
      <cfquery name="UpdateQuery" datasource="#mls.dsn#">
        ...
        SET
          clientid = <cfqueryparam cfsqltype="cf_sql_varchar" value='#TheClientID#'>
 ...
 <script type="text/javascript">
    $('#mlsModalCreate').on('hidden.bs.modal', function () {
      ...
      <tr>
        ...
        <td>
          <div>
            ...
            <!--- START: reCaptcha --->
              <script type="text/javascript"
              src="http://www.google.com/recaptcha/api/challenge?k=#attributes.publickey#">
              </script>
              <noscript>
              <iframe src="http://www.google.com/recaptcha/api/noscript?k=#attributes.publickey#"
            ...
            <!--- END: reCaptcha --->
              ...
              <tr>
                <cfoutput>
                  <td class="ContactForm" colspan="2"><br>
                    <table>
                      <tr>
                        <td><cfinput type="submit" name="SubmitForm" value="Create An Account" class="button" onClick="ga('send', 'event', { eventCategory: 'lead', eventAction: 'submitted', eventLabel: 'real-estate-request-more-info'});"></td>
                        <td><a hreflang="en" href="login.cfm<cfif isdefined('url.nomoreviewsallowed')>?nomoreviewsallowed=<cfelseif isdefined('action') and action is "addtofavorites">?#cgi.query_string#</cfif>" class="fb_dynamic button">Login</a></td>
                        <cfif isdefined('url.nomoreviewsallowed')><td><a hreflang="en" href="../search-results.cfm" target="_parent" class="button" style="float:right;">Continue without signing up</a></td></cfif>
                      </tr>
                    </table>
                  </td>
                </cfoutput>
