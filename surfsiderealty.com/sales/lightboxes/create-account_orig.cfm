...
<div id="mls-wrapper">
  ...
  <div align="right">
    <cfif isdefined('session.loggedin')>
      <a href="javascript:parent.$.fancybox.close();" id="fancybox-close">X</a>
    <cfelse>
      <cfoutput><a href="#returnlink#" target="_parent" id="fancybox-close">X</a></cfoutput>
    </cfif>
  </div>
  ...
  <cfif isdefined('processform')>
    ...
    <cfif Cffp.testSubmission(form)>
      ...
      <cfquery name="UpdateQuery" datasource="#mls.dsn#">
        ...
        SET 
          clientid = <cfqueryparam value="#TheClientID#" cfsqltype="CF_SQL_VARCHAR"> where TheCFID = '#CFID#' and TheCFTOKEN = '#CFTOKEN#'
      </cfquery>	
      <cfquery name="UpdateQuery" datasource="#mls.dsn#">
...
port="#cfmail.port#" useSSL="#cfmail.useSSL#" cc="#cfmail.cc#" bcc="#cfmail.bcc#">
        <cfinclude template="/sales/emails/_header.cfm">
          ...
          <p>You can now login to your account anytime at <a href="http://#SERVER_NAME#/sales/index.cfm?LinkToLogin=">http://#cgi.HTTP_HOST#/mls</a> using the following:</p>
      ...
      <cfelseif isdefined('action') and action is "SendToAFriend">
        <h3>
          <cfoutput>
            Thank you for creating an account with #mls.companyname#.<br>
            Please <a href="/sales/lightboxes/send-to-a-friend.cfm?&SendToAFriendwsid=#SendToAFriendwsid#&SendToAFriendmlsid=#SendToAFriendmlsid#&SendToAFriendmlsnumber=#SendToAFriendmlsnumber#">follow this link</a> to forward this property to your friend.<Br>
          </cfoutput>
        </h3>
      <cfelse>
        <cfoutput>
        ...
        <td>
          <div>
            <cfform action="#script_name#" method="post" name="thisform" onsubmit="return validateForm()"> 
              ...
              <tr>
                <td class="ContactForm">First Name:<br><cfinput type="Text" name="firstname" message="Please Enter Your First Name!" required="Yes" value="#session.userfirstname#"></td>
                <td class="ContactForm">Last Name:<br><cfinput type="Text" name="lastname" message="Please Enter Your Last Name!" required="Yes" value="#session.userlastname#"></td>
              </tr>
              <tr>
                <td class="ContactForm">Phone:<br><cfinput type="text" name="Phone" value="#session.userphone#"></td>
                <td class="ContactForm">Email:<br><cfinput type="Text" name="email" message="Please Enter A Valid Email Address!" validate="email" required="Yes" value="#session.useremail#"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="ContactForm" colspan="2"><br><cfinput type="submit" name="SubmitForm" value="Create An Account" class="button"> <a href="login.cfm?width=725&height=335" class="fb_dynamic button">Login</a></td>
              </tr>  
              </table>
            </cfform>
          </div>
