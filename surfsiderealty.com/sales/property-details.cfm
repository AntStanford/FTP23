		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
				  ...
				  <cfif GetListings.recordcount eq 0>
				    <p><strong>No listing found with this MLS Number. <br> Please visit our <a hreflang="en" href="/mls">Advanced Search Page</a> and try again.</strong></p>
				    <p>&nbsp;</p>
				  </cfif>
			        ...
			        <div class="mls-property-details">
			              ...
			              <ul>
			                ...
			                <cfif PreviousMLSNumberPosition gt "0">
			                  ...
			                  <cfquery DATASOURCE="#DSNMLS#" NAME="GetWSIDNext">
			                    SELECT *
			                    FROM mastertable
			                    where mlsnumber = <cfqueryparam cfsqltype="cf_sql_varchar" value='#PreviousMLSNumber#'> and mlsid = <cfqueryparam cfsqltype="cf_sql_varchar" value='#mlsid#'>
			                  </cfquery>
			                  ...
			                  <li class="prev-property"><a hreflang="en" href="#seolinkPrev#" class="button light">&lt; Previous Result</a></li>
			                </cfif>
			                <!--- <li><a hreflang="en" href="/sales/search-results.cfm?1=1<cfif isdefined('showmap')>&showmap=</cfif><cfif isdefined('start')>&start=#start#&searchpage=#searchpage#</cfif>" class="button light">Back to Search Results</a></li> --->
			                <li><a hreflang="en" href="/sales/search-results.cfm<cfif isdefined('session.searchpage')>?searchpage=#session.searchpage#</cfif>" class="button light">Back to Search Results</a></li>
			                ...
			                <cfif NextMLSNumberPosition lte "#listlen(session.PrevNextMLSNumbers)#">
			                  ...
			                  <cfquery DATASOURCE="#DSNMLS#" NAME="GetNextWSID">
			                    SELECT *
			                    FROM mastertable
			                    where mlsnumber = <cfqueryparam cfsqltype="cf_sql_varchar" value='#NextMLSNumberPosition#'> and mlsid = <cfqueryparam cfsqltype="cf_sql_varchar" value='#mlsid#'>
			                  </cfquery>
			                  ...
			                  <li class="next-property"><a hreflang="en" href="#seolinkNext#" class="button light">Next Result &gt;</a></li>
			                </cfif>
			              </ul>
			            </div>
			          </cfif>
			          <div class="side">
			            <div class="box property-images">
			              <div class="property-images-slideshowX">
			                ...
			                <cfif HowManyPhotos gt 0>
			                  <a class="various fancybox" rel="group1" href="#ThePhoto#"><img src="#Replace(thephoto,'http:','')#" alt="#mls.companyname# - MLS Number: #mlsnumber#" width="100%"></a>
			                  <cfloop index="i" list="#AllPhotos#">
			                    <a class="various fancybox" rel="group1" href="#i#" style="display:none;"><img src="#Replace(i,'http:','')#" alt="#mls.companyname# - MLS Number: #mlsnumber#" width="100%" ></a>
			                  </cfloop>
			                ...
			                <cfelse>
			                  <img src="http://mls.icoastalnet.com/sales/images/not_avail.jpg" alt="#mls.companyname# - MLS Number: #mlsnumber#" width="100%">
			                </cfif>
			                <!---shareit code--->
			                <div align="center">
			                ...
			                <!--- <ul class="social">
			                  ...
			                  <li><a hreflang="en" href="http://www.facebook.com/sharer.php?u=http://#cgi.SERVER_NAME#/sales/property-details.cfm?mlsnumber=#mlsnumber#&mlsid=#mlsid#&wsid=#wsid#&t=Check out this awesome listing!" target="_blank" class="facebook"></a></li>
			            ...
			            <div class="box quick-links">
			              <ul>
			                <li><a hreflang="en" href="/sales/printer-friendly.cfm?mlsnumber=#mlsnumber#&wsid=#wsid#&mlsid=#mlsid#" class="d-printer button" target="_blank">Printer Friendly Version</a></li>
			                <li><a hreflang="en" href="http://nces.ed.gov/globallocator/index.asp?search=1&State=#mls.state#&city=&zipcode=#mls.zip#&miles=10&itemname=&sortby=name&School=1&PrivSchool=1" class="d-nearby button" target="_blank">Nearby Schools</a></li>
			                ...
			                <!--- <cfinclude template="/sales/_mortgage-calculator.cfm"> --->
    ...
    where id = <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#GetAgentOnCall.agentid#">
			            ...
			            <!--- <cfif mls.EnableRoundRobin is "Yes" and GetAgent.recordcount gt 0>
			              <div class="box area">
			                ...
			                <br><a hreflang="en" href="/sales/lightboxes/request-more-information.cfm?action=requestinformation&wsid=#wsid#&mlsid=#mlsid#&mlsnumber=#mlsnumber#&width=545&height=474" class="fb_dynamic" title="Request more information about this property.">Contact Me Today!</a>
			              </div>
			            </cfif> --->
			          ...
			          <div class="box main">
			            <h1><em>#dollarformat(list_price)# <cfif wsid is "4">/ Monthly</cfif></em> #street_number# #street_name#
			            	<cfif LEN(unit_number)>#unit_number#</cfif></h1>
			            <ul class="box details-list">
			              <li><b>MLS##:</b>#mlsnumber#</li>
			              <li><b>Address:</b> <cfif AddressDisplayYN is not "N">#street_number# #street_name# <cfif LEN(unit_number)>#unit_number#</cfif><cfelse>N/A</cfif></li>
			              ...
			              <cfif total_heated_square_feet is not ""><li><b>Sq Ft:</b>#trim(total_heated_square_feet)#</li></cfif>
			              ...
			              <li class="favorite">
			                <cfif isdefined('cookie.LoggedIn')>
			                  <cfquery name="CheckFavorite" dbtype="query">
			                    SELECT *
			                    FROM CheckFavorites
			                    where clientid = <cfqueryparam value="#cookie.LoggedIn#" cfsqltype="cf_sql_numeric"> and mlsnumber = <cfqueryparam cfsqltype="cf_sql_varchar" value='#mlsnumber#'> and wsid = <cfqueryparam cfsqltype="cf_sql_varchar" value='#wsid#'> and mlsid = <cfqueryparam cfsqltype="cf_sql_varchar" value='#mlsid#'>
			                  </cfquery>
			                  <cfif CheckFavorite.recordcount gt 0>
			                    <a class="button light" href="/sales/property-details.cfm?action=removefromfavorites&FavoriteWSID=#wsid#&FavoritemLSID=#mlsid#&Favoritemlsnumber=#mlsnumber#">Remove Favorite</a>
			                  <cfelse>
			                    <a class="button light" href="/sales/property-details.cfm?action=addtofavorites&FavoriteWSID=#wsid#&FavoritemLSID=#mlsid#&Favoritemlsnumber=#mlsnumber#">Add Favorite</a>
			                  </cfif>
			                <cfelse>
			...
			<!---               <li class="more-info"><a class="button light fb_dynamic" href="/sales/lightboxes/request-more-information.cfm?action=requestinformation&wsid=#wsid#&mlsid=#mlsid#&mlsnumber=#mlsnumber#&width=600&height=474" title="Request more information about this property.">Request More Info</a></li></li> --->
			              ...
			              <cfif isdefined('cookie.LoggedIn')>
			              		<li class="forward-friend"><a class="button light " data-toggle="modal" data-target="##mlsModalSTAF" data-mlsnum="#mlsnumber#" data-mlsid="#mlsid#" data-wsid="#wsid#" data-msg="Check out this property listed on #mls.companyname#.  MLS ## #mlsnumber# http://#cgi.HTTP_HOST#/sales/property-details.cfm?mlsnumber=#mlsnumber#&mlsid=#mlsid#&wsid=#wsid#">Send to a friend</a></li>
				            <cfelse>
              ...
              <div class="box walkscore contained">
                <script type='text/javascript'>
                var ws_wsid = '70326befc4f04a0db6d2137c54269510';
                var ws_address = '#street_number# #street_name#, #city#, #state# #zip_code#';
                var ws_width = '100%';
                var ws_height = '268';
...
<cfif cgi.remote_addr neq '45.42.5.230'>
  <cfoutput>
  <script>
