...
<cfset variables.pratikIP = '103.251.19.190' />
<cfset variables.teresaIP = '75.167.233.18' />
<cfset variables.saraIP = '69.108.40.77' />
...
<cfif   cgi.remote_addr NEQ variables.officeIP AND 
        ...
        cgi.remote_addr NEQ variables.pratikIP AND
...
<html lang="en">
    <head>
  <!-- //www.1stwebdesigner.com/design/snippets-html5-boilerplate/ -->
...
--------------------------------------------------------------------------------------------------
    ...
    Link:
    //www.bennadel.com/index.cfm?event=blog.view&id=553
