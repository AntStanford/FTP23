...
<cfapplication name="#prefix#_blog_#blogname#" sessionManagement="true" loginStorage="session" sessiontimeout="#sessiontimeout#">
...
<cfif not isDefined("application.init") or isDefined("url.reinit")>
	...
	<cfif cgi.http_host contains('dev')>
		<cfset application.rootURL = replace(application.rootURL,'www','dev')>
	</cfif>
