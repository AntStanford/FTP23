...
<cfcomponent displayName="Blog" output="false" hint="BlogCFC by Raymond Camden">
	...
	<cffunction name="getComments" access="remote" returnType="query" output="false"
		...
		<cfquery name="getC" datasource="#instance.dsn#" username="#instance.username#" password="#instance.password#">
			...
			order by	tblblogcomments.posted 

			<cfset variables.allowedSortList = "asc,desc">
			   <cfif listFindNoCase(variables.allowedSortList, arguments.sortdir)>
			     	<cfset variables.allowedSort = arguments.sortdir>
			   <cfelse>
			     	<cfset variables.allowedSort = "asc">
			   </cfif>
				#variables.allowedSort#
		</cfquery>
	...
	<cffunction name="getEntries" access="remote" returnType="struct" output="false"
		...
		<cfset r.orderby = arguments.params.orderBy>
		<cfset r.dsn = instance.dsn>
		<cfset r.ids = getIds>
...
<a href="#getRootURL()#unsubscribe.cfm?email=#email#&token=#token#">#getRootURL()#unsubscribe.cfm?email=#email#&token=#token#</a>
	...
	<cffunction name="makeLink" access="public" returnType="string" output="false"
		...
		<cfif cgi.http_host contains('dev')>
			<cfset instance.blogURL = replace(instance.blogURL,'www','dev')>
		</cfif>
